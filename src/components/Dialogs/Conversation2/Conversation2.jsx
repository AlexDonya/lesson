...
const Conversation2 = (props) => {
    ...
    const messages1Elements = props.conversation2.messages1.map(m => <Message1 key={m.id} message1={m.message} />);
    const messages2Elements = props.conversation2.messages2.map(m => <Message2 key={m.id} message2={m.message} />);
